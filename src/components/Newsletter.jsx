...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      <h1 className='md:text-4xl font-semibold'>Stay Updated with Blogram!</h1>
      <p className='md:text-lg text-gray-500/70 pb-8'>Subscribe to our newsletter and never miss a blog. Get the latest tech insights, dev tools, <br />and AI-powered updates delivered straight to your inbox.</p>
